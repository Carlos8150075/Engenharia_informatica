...
public class Directory extends javax.swing.JFrame {
    ...
    private boolean validateForm() {
        ...
        String birthMonth = jTextField3.getText();
        String bithYear = jTextField4.getText();

        if (name.isEmpty() || birthDay.isEmpty() || birthMonth.isEmpty() || bithYear.isEmpty()) {
            return false;
        } else {
            return true;
        }
    ...
    public static Date parseDate(String target) throws ParseException {
        DateFormat df = new SimpleDateFormat("yyyy-MM-dd kk:mm:ss", Locale.getDefault());
